...
This analysis is informative but impractical to do regularly because the datasets are very large; last semester's dataset contained >11,000 text-based comments plus metadata. 
...
The long-range goal is NOT automated scoring of student writing. Rather, we hope to use classification of instructor comments as a tool for:

* Guiding how we train graduate TAs to teach students to write.
* More rapidly diagnosing the most common problems students have. 

Based on that information we will tailor how we teach writing so it focuses more on those specific student challenges.  
...
----------|---------------------------------------------------------
ID#|R_XX value
record.id|Semester ID and 5-digit number, like Sp18.00001. Indicates individual data lines. Once assigned, it should not change.
