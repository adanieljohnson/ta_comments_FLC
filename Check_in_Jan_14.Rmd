...
My project is partly exploratory, in I am asking: what information is present and can be mined from the dataset? It also is partly predictive in that I hope to use the analysis as part of a decision- or task-oriented process.

Data parameters to consider:
...
*  Stylometry library
*  QualtRics package for connecting to API
