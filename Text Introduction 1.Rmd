---
title: "Text Analysis Intro,  Fall 2018"
author: "Dan Johnson"
date: "9/12/2018"
...
```
Run this line for a Mac OS to set working directory folder.

```{r}
setwd("~/Dropbox/Coding_Tools/R_Environment/R_Projects")
...
Let's begin by creating an object consisting of a character string. In this case, the first sentence from Sense and Sensibility.
...
Doing things like counting words requires us to split a long string of text into individual constituents or "words". To do this, we can use the function "strsplit", which requires us to specify the object we want to spit ("text") and where to split it (at spaces).
